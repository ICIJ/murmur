  ...
  <span class="brand" :style="style">
    <svg :width="width" :height="height" viewBox="0 0 147.151 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <path class="globe"
        ...
        style="stroke-width:.608717" />
      <path class="plate" transform="rotate(90 0 0)" style="stroke-width:.608717"
        d="M136.809-147.151h10.622V0h-10.622z" />
    </svg>
  </span>
</template>
